...
class VolumetricRenderer(nn.Module):
    ...
    # def forward_2(self, raw, z_vals, rays_d, **kwargs):
    ...
    def forward(self, raw, z_vals, rays_d, **kwargs):
        ...
        # CHECK(disp_map=disp_map, depth=depth_map, acc=acc_map)
        # CHECK_ZERO(acc_map=acc_map, depth_map=acc_map)
